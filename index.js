...
let songs=[
  ...
  {songName:"Different Heaven - My Heart [NCS Release]", filePath:"songs/4.mp3", coverPath:"covers/4.jpg"},
...
audioElement.addEventListener('timeupdate', ()=>
{
  ...
  playButton.value=progress;
})

playButton.addEventListener('change', ()=>{
  audioElement.currentTime=playButton.value * audioElement.duration/100;
})
